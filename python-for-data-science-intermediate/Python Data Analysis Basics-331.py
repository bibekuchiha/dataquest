...
print("{0}'s birth year is {1}".format(artist, birth_year))
...
for pop in pop_millions:
    name = pop[0]
    population = pop[1]
    print("The population of {name} is {population:,.2f} million".format(name=name, population=population))
...
for key, value in gender_freq.items():
    output = "There are {v:,} artworks by {k} artists".format(v=value,k=key)
    print(output)
